...
@endif
<form method="get" action="{{url('brandupdate',$category->id)}}" enctype="multipart/form-data">
  @csrf
        

        <div class="form-group">
          <label>category</label>
          <input type="text" value="{{$category->title}}" name="category" class="form-control" placeholder="Product category">
        </div>
