...
@endif
<form method="get" action="{{url('categoryupdate',$category->id)}}" enctype="multipart/form-data">
  @csrf
        

        <div class="form-group">
          <label>category</label>
          <input type="text" value="{{$category->cat_title}}" name="category" class="form-control" placeholder="Product category">
        </div>
